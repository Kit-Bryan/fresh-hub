...
<head>
    ...
    <link href = "../manageProducts/productsAndProfiles.css" rel = "stylesheet" type = "text/css">
...
<body style = "background-color:white ;">
    ...
    <div style = "background-color: white;" class="modify-inquiry">
        ...
        <a href="../viewProducts/productPage.php"><button class="inquiry-reset">Reset</button></a>
    </div>
